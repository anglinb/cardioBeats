...
// Original script by Paul Lutz and Scott Martin
// Customized to work with timestamps by Mico Abrina
// Fabricate.IO
#include <iostream>
#include <thread>
#include <mutex>
...
public:
    DataCollector() : onArm(false), curr_time(0), currentPose() {
    ...
    void print() {
		...
		//Prints timestamp of the Myo => Mico Abrina
		std::cout << curr_time;
